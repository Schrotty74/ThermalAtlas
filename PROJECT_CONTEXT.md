...
- Ein gemeinsames Footer-Menü bündelt `Themes`, `Scan Refresh`, `Window Size`, `Visible Temperatures`, `Menu Bar Display`, `Temperature Alerts`, `Language` beziehungsweise `Sprache`, `Export`, öffentliche GitHub- und Homepage-Links, die englischen und deutschen Handbücher, das Öffnen der macOS-Aktivitätsanzeige und das Beenden der App. Aktive Auswahlwerte sind jeweils mit einem Häkchen markiert.
