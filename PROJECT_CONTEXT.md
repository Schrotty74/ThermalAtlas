...
- `README.md` und `README.de.md` sind gleichwertige öffentliche Dokumentationen: Sie zeigen beide die vier Theme-Screenshots sowie gleichwertige Installations-, Gatekeeper-, Datenschutz-, Status-, Lizenz- und Linkinformationen. Ihre öffentliche Tabelle führt nur die veröffentlichten Beta- und Final-Build-Kanäle; der rein lokale Dev-Kanal wird dort nicht aufgeführt. Auf dem Beta-Stand enthalten sie außerdem einen eigenen Hardware-Kompatibilitätsabschnitt mit den nur auf M4 Max, M5 und M5 Pro bestätigten CPU-/GPU-Erkennungen. Der Changelog bleibt ausschließlich Englisch.
