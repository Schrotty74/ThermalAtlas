...
- Nach einem ausdrücklich beauftragten Final-Build wird der Handbuchstand auf `main` gegen `beta` geprüft. Sind die Final-Handbücher aktueller, werden nur die Handbuchquellen, PDFs, ihr Generator und dessen unmittelbar verwendete Bildressourcen nach `beta` übernommen und gepusht. Final-Quellcode, Version, Tag und Release bleiben dabei ausschließlich auf `main`.
