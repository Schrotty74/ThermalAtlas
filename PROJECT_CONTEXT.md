...
- ThermalAtlas Beta 0.3.0 wird als GitHub-Pre-Release vom Branch `beta` mit Tag `v0.3.0` veröffentlicht. Es enthält eine ad-hoc-signierte DMG mit Applications-Link, eine ZIP-Datei und SHA-256-Prüfsummen für beide Downloads. Prüfsummen, App-Signatur und der Inhalt der bereitgestellten DMG werden vor dem Upload lokal geprüft.
