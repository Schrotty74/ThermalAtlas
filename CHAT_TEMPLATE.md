# Chat-Startvorlage – ThermalAtlas Beta

Ich arbeite am Projekt **ThermalAtlas** auf dem Branch `beta`.

Projekt-Root:
`Repository-Root`

Repository:
https://github.com/Schrotty74/ThermalAtlas
...
Prüfe vor Aussagen oder Änderungen den tatsächlichen Stand dieses Beta-Branches. Lies danach nur die für den Auftrag relevanten Quell-, Build- und Konfigurationsdateien. Den aktuellen Repository-Stand höher gewichten als frühere Chats.
